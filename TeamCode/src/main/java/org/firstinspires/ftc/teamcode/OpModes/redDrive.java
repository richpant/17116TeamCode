...
public class redDrive extends OpMode {
    ...
    public void loop() {
        ...
        if (gamepad2.dpad_up) {
            ...
            rightLift.setTargetPosition(-30);
            leftLift.setTargetPosition(-30);
            middleLift.setTargetPosition(100);
            rightLift.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            leftLift.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            middleLift.setMode(DcMotor.RunMode.RUN_TO_POSITION);
            ...
            middleLift.setVelocity(1500);
               ...
               /* rightLift.setTargetPosition(900);
                ...
                middleLift.setTargetPosition(200);
                middleLift.setMode(DcMotor.RunMode.RUN_TO_POSITION);
